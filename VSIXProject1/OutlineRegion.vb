''------------------------------------------------------------------------------
'' <copyright file="OutlineRegion.vb" company="Microsoft">
...
''' <summary>
''' Classifier that classifies all text as an instance of the "OutlineRegion" classification type.
''' </summary>
Friend NotInheritable Class OutlineRegion
    ...
    ''' <summary>
    ''' Initializes a new instance of the <see cref="OutlineRegion"/> class.
    ''' </summary>
    ''' <param name="registry">Classification registry.</param>
    Friend Sub New(ByVal registry As IClassificationTypeRegistryService)

        Me.classificationType = registry.GetClassificationType("OutlineRegion")
