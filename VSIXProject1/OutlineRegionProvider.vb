''------------------------------------------------------------------------------
'' <copyright file="OutlineRegionProvider.vb" company="Microsoft">
...
Friend NotInheritable Class OutlineRegionProvider
    ...
    Public Function GetClassifier(ByVal buffer As ITextBuffer) As IClassifier Implements IClassifierProvider.GetClassifier
        ...
        Return buffer.Properties.GetOrCreateSingletonProperty(Of OutlineRegion)(Function() New OutlineRegion(Me.classificationRegistry))
